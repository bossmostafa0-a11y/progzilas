// src/pages/developer/AddPreviousProject.jsx
...
export default function AddPreviousProject() {
  ...
  const progressSteps = [
    ...
    { number: 3, title: 'الصور والنشر', icon: '🚀' }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-indigo-50/20" dir="rtl">
      ...
      <div className="flex-grow flex">
        <DeveloperSidebar activePage="add-previous-project" />
        ...
        <div className="flex-1 overflow-x-auto">
          <div className="p-6 lg:p-8">
            ...
            >
              ...
              <p className="text-gray-500 mt-1">أضف اعمالك السابقة لتظهر مدى خبرتك</p>
            </motion.div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      {formData.videoFile ? (
                        ...
                        <div className="border-2 border-dashed rounded-xl p-4 text-center transition-all border-gray-300 hover:border-indigo-500">
                          <input
                            type="file"
                          ...
                          <label htmlFor="videoUpload" className="cursor-pointer">
                            ...
                            <p className="text-sm text-gray-500">اضغط لرفع فيديو (اختياري)</p>
                            <p className="text-xs text-gray-400 mt-1">MP4, WebM, OGG - أقصى حجم 250 ميجا</p>
                          </label>
                        </div>
                      )}
