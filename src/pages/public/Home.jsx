      ...
      <main className="flex-grow relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 px-5 py-2.5 rounded-full mb-8 shadow-sm"
            >
              <span className="relative flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-indigo-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-indigo-500"></span>
              </span>
              <span className="text-sm font-bold">🚀 منصة المبرمجين العربية الأولى | أكثر من 850 مبرمجاً وثقوا بنا</span>
            </motion.div>
            ...
            <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight">
              ...
              <br />
              <span className="text-gray-800">متخصصة في توظيف</span>
              <br />
              <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">
                المبرمجين
              </span>
            ...
            <motion.p variants={fadeInUp} className="text-xl md:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              DevHire هي <span className="font-bold text-indigo-600">LinkedIn + GitHub + Upwork</span> في مكان واحد.
              <span className="block text-indigo-600 font-bold mt-3 text-lg">
                ✨ بيع مشروعك أكثر من مرة وحقق دخل سلبي حقيقي ✨
              </span>
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-5 justify-center mb-24">
              ...
              <Link to="/login" className="group border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-600 hover:text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 hover:shadow-xl hover:scale-105 text-lg">
                ✨ سجل كمبرمج وابدأ الربح
              </Link>
            </motion.div>
              ...
              <div className="grid md:grid-cols-3 gap-8 relative">
                {steps.map((step, index) => (
                  <motion.div
                    ...
                    className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 text-center group"
                  >
        ...
        <div className="relative py-24 bg-gradient-to-br from-gray-50 via-white to-indigo-50/30 z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {topDevelopers.map((dev, index) => (
                ...
                >
                  <div className="relative h-32 overflow-hidden">
                    <img src={dev.cover} alt={dev.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                    <div className="absolute bottom-2 right-3">
                      <span className="px-2 py-1 bg-yellow-400 text-gray-800 text-xs font-bold rounded-full shadow-lg">
                        {dev.badge}
                      </span>
                    </div>
                  </div>
                    ...
                    <div className="text-left pt-14 pb-4">
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          ...
                          <p className="text-sm text-indigo-600 font-semibold">{dev.title}</p>
                        </div>
                        <div className="text-right">
                          <div className="text-2xl font-bold text-indigo-600">${dev.hourlyRate}</div>
                      ...
                      <div className="flex items-center gap-1 mb-3">
                        ...
                        <span className="text-gray-400 text-sm">({dev.completed} مشروع)</span>
                      </div>
                      ...
                      <Link to={`/dev/${dev.name}`} className="block w-full text-center py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all duration-300">
                        عرض البروفايل
                      </Link>
                    </div>
                  </div>
            ...
            <div className="text-center mt-12">
              <Link to="/developers" className="inline-flex items-center gap-2 text-indigo-600 font-bold hover:gap-3 transition-all duration-300">
                عرض جميع المبرمجين
        ...
        <div className="relative py-24 bg-white/50 backdrop-blur-sm z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  <div className="flex flex-col md:flex-row">
                    <div className="md:w-2/5 relative overflow-hidden">
                      <img src={project.image} alt={project.name} className="w-full h-48 md:h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                      <div className="absolute top-3 right-3 bg-black/70 text-white px-2 py-1 rounded-lg text-xs font-bold">
                        {project.sales} عملية بيع
                      </div>
                    </div>
                    <div className="md:w-3/5 p-6 text-right">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="px-2 py-1 bg-indigo-100 text-indigo-700 text-xs rounded-full">{project.category}</span>
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        <img src={project.devAvatar} alt={project.dev} className="w-6 h-6 rounded-full" />
                        <span className="text-sm text-gray-600">{project.dev}</span>
                      </div>
                      <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      <div className="flex justify-between items-center">
                        <Link to={`/marketplace/${project.id}`} className="px-5 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 text-sm">
                          تفاصيل المشروع
                        </Link>
            ...
            <div className="text-center mt-12">
              <Link to="/marketplace" className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold py-3 px-8 rounded-xl hover:shadow-xl transition-all duration-300 hover:scale-105">
